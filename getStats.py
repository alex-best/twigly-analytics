...
class LateDeliveryHandler(BaseHandler):
	...
	def get(self):
		...
		for item in result1:
			outputtable += "<tr><td>" + str(item[0]) + "</td><td>"+str(item[2])+"</td><td>"+str(item[10])+"</td><td>" + prioritylookup[item[1]] +"</td><td><a href='http://twigly.in/admin/orders?f="+str(item[3])+"'>"+str(item[3])+"</a></td><td>"+str(item[9])+"</td><td>"+str(item[4])+"</td><td>"+str(item[5])+"</td><td>"+str(item[6])+"</td><td>"+str(item[7])+"</td><td>"+str(item[8])+"</td></tr>"
