...
def authenticate(thisusername, thispassword):
	if (thisusername == "admin" and thispassword == "") or (thisusername == "review" and thispassword == "rvwdash") or (thisusername == "chef" and thispassword == "twigly123") or (thisusername == "chef03" and thispassword == "twiglychef03") or (thisusername == "headchef" and thispassword == "rahulonly") or (thisusername == "twiglyservice" and thispassword == "callcenter") or (thisusername == "@testmail.com" and thispassword == "dispatch02")  or (thisusername == "@testmail.com" and thispassword == "dispatch03")  or (thisusername == "@testmail.com" and thispassword == "dispatch05") :
		return {"result": True}
	else:
		return {"result": False}
